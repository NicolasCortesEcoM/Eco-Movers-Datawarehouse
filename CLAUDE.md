...
| `core`                                 | Canonical, cross-source-resolved entities: `opportunities`, `jobs`, `leads`, `branches`, `lines_of_business`, `opportunity_charges`, `opportunity_payments` | dbt only + read-only apps (unstable, see rule 6) |
