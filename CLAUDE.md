...
- `pipeline/report_bot/` - Playwright bot that drives the SmartMoving **UI** so All Jobs
  ...
  exactly like the other three reports. One parser, one landing contract. Instances live
